                        ...
                        <div class="ibox-content">
                            ...
                            <form action="" method="POST">
                               @csrf
                                ...
                                <div class="form-group row"><label class="col-lg-2 col-form-label"><b>Request Type Name</b></label>

                                    <div class="col-lg-10">
                                        <input type="text" id="request_type_name" placeholder="Request Type Name" class="form-control" name="request_type_name">
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                         ...
                                         $system_id = $single_data->system_id; 
                                           ...
                                           $system_data = DB::table('systems')->where('id', "$system_id")->first();
                                           ...
                                           echo $system_data->system_name;
                                            ...
                                            <td style="width:28%"><button onclick="edit_request_type(<?php echo $single_data->id; ?>)" class="btn btn-sm btn-info">Edit</button> 
